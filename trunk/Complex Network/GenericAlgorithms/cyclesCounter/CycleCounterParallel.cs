...
namespace Algorithms
{
    ...
    class CycleCounterParallel : ICycleCounterInternal, IThreadEvent
    {
        ...
        public long getCycleCount(int cyclesLenght)
        {
            ...
            {
                _counters[i] = new PivotsCycleCounter(this, _container, i, cyclesLenght);
        ...
        public void threadFinished(long cyclesCount, HashSet<int[]> cycles) {
     ...
     */
    class PivotsCycleCounter
    {
        private IThreadEvent _handler;
