...
using Model.ERModel.Realization.CycleCounting;
using log4net;
...
namespace Model.ERModel.Realization
{
    ...
    public class CyclesCounter
    {
        ...
        // reference to the ERContainer object which contains the graph
        private ERContainer _container;
        ...
        public CyclesCounter(ERContainer container)
        {
